...
import pickle #To download and manage machine learning model
from sklearn import preprocessing 
loaded_model = pickle.load(open('model.sav', 'rb')) #Load model using pickel
...
def main():
    ...
    TENURE = st.text_input("What is the duration of the network")
    ...
    REVENUE = st.number_input("What is the monthly income of the client")
    ...
    DATA_VOLUME = st.number_input("What is the number of connection")
    ...
    TOP_PACK = st.text_input("What is the most acive packs")
